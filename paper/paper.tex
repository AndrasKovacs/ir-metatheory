...
concrete formulation that we use is the type-theoretic gluing by \citet{gluing}, which is the same
as Coquand's version \cite{coquand2018canonicity} when gluing along the global sections
functor. This is a variation of gluing which uses dependent type families instead of the fibered
families of the categorical flavor. The type-theoretic style becomes valuable when we get to the
interpretation of more complicated type formers, where it is easier to use than diagrammatic
reasoning.
