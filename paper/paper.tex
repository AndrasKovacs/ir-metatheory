...
\keywords{inductive-recursive types, canonicity}
...
\begin{alignat*}{3}
  &\hspace{-3em}\rlap{$\E : \{i\,j : \mbb{N}\}\{O : \U_j\} \to \Sig_i\,O \to (\ir : \U_i) \to (\ir \to O) \to \U_i$} \\
  &\hspace{-3em}\E\,(\iota\,o)    \,&&\ir\,\el && \hspace{-0.7em}:\equiv \top\\
  &\hspace{-3em}\E\,(\sigma\,A\,S)\,&&\ir\,\el && \hspace{-0.7em}:\equiv (a : A) \times \E\,(S\,a)\,\ir\,\el\\
  &\hspace{-3em}\E\,(\delta\,A\,S)\,&&\ir\,\el && \hspace{-0.7em}:\equiv (f : A \to \ir) \times \E\,(S\,(\el \circ f))\,\ir\,\el\\
  &\hspace{-3em} && &&\\
  &\hspace{-3em}\rlap{$\F : \{i\,j : \mbb{N}\}\{O : \U_j\}\{S : \Sig_i\,O\}\{\ir\}\{\el\} \to \E\,S\,\ir\,\el \to O$} \\
  &\hspace{-3em}\F\,\{\iota\,o\}    \,&&x       && :\equiv o\\
  &\hspace{-3em}\F\,\{\sigma\,A\,S\}\,&&(a,\,x) && :\equiv \F\,\{S\,a\}\,x\\
  &\hspace{-3em}\F\,\{\delta\,A\,S\}\,&&(f,\,x) && :\equiv \F\,\{S\,(\el \circ f)\}\,x
\end{alignat*}
...
We formalized Section \ref{sec:iir-construction} in roughly 250 lines of Agda \cite{ir-canonicity-supplement}, using the same
...
\begin{alignat*}{4}
  ...
  & \hspace{2em} \sigma\,(\Tm\,(\El\,(A\,\ttt) \to \IR\,S^*))\,\$\,\lambda\,B.\,
                      \delta\,((a : \Tm\,(\El\,(A\,\ttt))) \times {ElA}^\w\,(\ttt,\,\ttt)\,a)\,(B \circ \fst)\,\$\,\lambda\,{ElB}^\w.\\
  & \hspace{2em} \iota\,\,(\intro\,(\Pi',\,A,\,B,\,\ttt))\,(\lambda\,f.\,\{a : \Tm\,(\El\,(A\,\ttt))\}(a^\w : {ElA}^\w\,(\ttt,\,\ttt)\,a) \to {ElB}^\w\,(a,\,a^\w)\,(f\,a))
\end{alignat*}
This specifies essentially the same IIR type that we have seen in Example \ref{ex:code-canonicity}.
We get some extra noise in the first inductive argument of $\Pi'^\w$, which is now a function with domain
$\Tm\,\top \times \top$, and some more noise in the second inductive argument, where we pack the inputs into a
$\Sigma$-type. We do not get stuck on neutral tags here either, but for a different reason: we have
function extensionality and equality reflection in the metatheory, so we are allowed to push
computation under the $t^\w$ splitting, up to meta-level definitional equality.
...
fix it up with additional constraints.
\begin{alignat*}{4}
...
\ref{sec:ir-canonicity} in Agda \cite{ir-canonicity-supplement}, but we did not formalize the object
theory nor the contextual interpretations for its rules. The formalization is roughly 280
lines. Overall, we have found the Agda formalization to be extremely useful and it was crucial for
coming up with the right definitions in the first place.
