...
interpretation, which are the CwF, universes and functions. The interpretation of empty and extended
...
$\Sig^\w$; the naming risks some confusion, but we shall take the risk.
\begin{alignat*}{4}
...
$\Sig^\w\,O^\w\,t$. To fully interpret the object-theoretic $\Sig$, we also need to interpret the constructors
and the eliminator.
